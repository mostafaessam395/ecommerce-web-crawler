...
class CrowlCsvPipeline:
    ...
    def __init__(self, crawler):
        ...
        output_name = self.settings.get('OUTPUT_NAME', 'output')
        ...
        self.urls_file = open('{}_urls.csv'.format(output_name), 'ab')
        ...
        self.links_file = open('{}_links.csv'.format(output_name), 'ab')
